var elements = [
    ...
    {tag: 'input', text: '学号 :', attr:{type: 'text',name: 'sid'}},
    {tag: 'input', text: '班级 :', attr:{type: 'text',name: 'classid'}},
    {tag: 'input', text: '性别 :', attr:{type: 'radio',name: 'gender'},
    option:{m: '男',w: '女'}},
    {tag: 'input', text: '爱好:', attr:{type:'checkbox',name:'hobby[]'},
